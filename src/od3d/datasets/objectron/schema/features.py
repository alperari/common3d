...
FEATURE_MAP = {
    ...
    FEATURE_NAMES["INTRINSIC_MATRIX"]: tf.io.VarLenFeature(dtype=tf.float32),
    FEATURE_NAMES["EXTRINSIC_MATRIX"]: tf.io.VarLenFeature(dtype=tf.float32),
    FEATURE_NAMES["ORIENTATION"]: tf.io.VarLenFeature(dtype=tf.string),
    FEATURE_NAMES["OBJECT_NAME"]: tf.io.VarLenFeature(dtype=tf.string),
    FEATURE_NAMES["OBJECT_TRANSLATION"]: tf.io.VarLenFeature(dtype=tf.float32),
    FEATURE_NAMES["OBJECT_ORIENTATION"]: tf.io.VarLenFeature(dtype=tf.float32),
    FEATURE_NAMES["OBJECT_SCALE"]: tf.io.VarLenFeature(dtype=tf.float32),
    FEATURE_NAMES["VISIBILITY"]: tf.io.VarLenFeature(dtype=tf.float32),
    FEATURE_NAMES["PLANE_CENTER"]: tf.io.VarLenFeature(dtype=tf.float32),
    FEATURE_NAMES["PLANE_NORMAL"]: tf.io.VarLenFeature(dtype=tf.float32),
}
...
SEQUENCE_CONTEXT_MAP = {
    "sequence_id": tf.io.FixedLenFeature(shape=[], dtype=tf.string, default_value=""),
    "count": tf.io.FixedLenFeature(shape=[], dtype=tf.int64, default_value=-1),
}
