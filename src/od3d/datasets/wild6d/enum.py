...
MAP_CATEGORIES_OD3D_TO_WILD6D = {
    ...
    OD3D_CATEGORIES.LAPTOP: WILD6D_CATEGORIES.LAPTOP,
    OD3D_CATEGORIES.CAMERA: WILD6D_CATEGORIES.CAMERA,
    OD3D_CATEGORIES.BOTTLE: WILD6D_CATEGORIES.BOTTLE,
    OD3D_CATEGORIES.BOWL: WILD6D_CATEGORIES.BOWL,
}

# MAP_CATEGORIES_WILD6D_TO_OD3D = {v: k for k, v in MAP_CATEGORIES_OD3D_TO_WILD6D.items()}
MAP_CATEGORIES_WILD6D_TO_OD3D = {
    WILD6D_CATEGORIES.MUG: OD3D_CATEGORIES.CUP,
    WILD6D_CATEGORIES.LAPTOP: OD3D_CATEGORIES.LAPTOP,
    WILD6D_CATEGORIES.CAMERA: OD3D_CATEGORIES.CAMERA,
    WILD6D_CATEGORIES.BOTTLE: OD3D_CATEGORIES.BOTTLE,
    WILD6D_CATEGORIES.BOWL: OD3D_CATEGORIES.BOWL,
}
